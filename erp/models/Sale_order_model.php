...
class Sale_order_model extends CI_Model
{
	...
	{
		$this->db
			 ->select("erp_sale_order.order_discount,erp_sale_order.term_id,erp_sale_order.principle_type,erp_sale_order.installment_date,companies.name,companies.phone,companies.gender,companies.date_of_birth,companies.cf1 as identify_card,terms.description,term_types.name as term_name")
