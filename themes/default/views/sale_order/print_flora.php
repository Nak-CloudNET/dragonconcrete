...
<!-- <input type="button" value="Print Div" onclick="PrintElem('#mydiv')" /> -->
		<div class="container">
			<div class="row col-lg-12">
				...
				<div class="col-lg-12">
					<h4 class='text-center moul'><b>ពាក្យស្នើរសុំទិញ-លក់ផ្ទះ</b></h4><br>
				</div>
				<div class="col-lg-12 description">
						<p>ធ្វើនៅថ្ងៃទី <b><?php echo $date_day ?> </b>ខែ <b><?php echo $date_month ?></b> ឆ្នាំ <b><?php echo $date_year ?></b></p>
						<p><span style="padding-right:10px">១. អ្នកទិញ : លោក/លោកស្រី</span>
							<span style="padding-right: 10px !important;"><b> 
								<?php
							...
							<span style="padding-right:10px">អត្ត/ប័ណ្ណ </span>
								<span style="padding-right: 10px !important;"><b> 
									<?php if($customer->cf1 == ""){echo "……………………";}else{echo $customer->cf1;} ?> 
								</b></span>
							<span>	និងឈ្មោះ </span>
								<span style="padding: 10px !important;"><b><?=($jl_data->name!=""?$jl_data->name:".................")?></b></span>
							<span style="padding-right:10px">អត្ត/ប័ណ្ណ</span>
							<span style="padding-right: 10px !important;"> <b><?=($jl_data->identify_card!=""?$jl_data->identify_card:"...........")?></b></span> 
						</p>
						<p>
							<span style="padding-right:10px">អាស័យដ្ឋានផ្ទះលេខ </span> 
								<span style="padding-right: 10px !important;"><b>
									<?php if($customer->address == ""){echo "………………";}else{echo $customer->address;} ?>	
								</b></span>
							<span style="padding-right:10px">ផ្លូវលេខ </span>
								<span style="padding-right: 10px !important;"><b>
									<?php if($customer->street == ""){echo "…………";}else{echo $customer->street;} ?>
								</b></span>
							ភូមិ
								<span style="padding: 10px !important;"><b>
									<?php
									if($customer->village == ""){echo "…………………………";}else{echo $customer->village;} ?>
								</b></span>
								<span style="padding-right:10px">	ឃុំ/សង្កាត់ </span>
						</p>
						<p>
							...
							<span style="padding-right:10px">ស្រុក/ខណ្ឌ</span>
								<span style="padding-right: 10px !important;"><b>
						...
						<p>២. ការទិញលក់: ប្រភេទផ្ទះ
							...
							ដែលមានទទឹង
								<span style="padding: 10px !important;"><b><?php
								if($height  == ""){echo "………………";}else{echo $height;}
								 ?></b></span>
							ម៉ែត្រ, បណ្ដោយ
							
								<span style="padding: 10px !important;"><b><?php if($width  == ""){echo "………………";}else{echo $width;}
								  ?></b></span>
							ម៉ែត្រ
						</p>
						<p><span style="padding-right:10px">ផ្ទះលេខ </span>
							...
							ទីតាំង
								<span style="padding-right:10px"><b><?php if($rows->cf2){ echo $rows->cf2; }else{
									echo "………………";
								} ?></b></span>
							រយះពេលសាងសង់
								<span><b>………………………</b></span>
						...
						<p>តម្លៃដើម
								<span style="padding-right: 10px !important;"><b><?php if($rows->unit_price){ echo $this->erp->formatMoney($rows->unit_price); }else{
									echo "………………………";
								} ?></b></span>
							<span style="padding-right:10px;">US$ បញ្ចុះតម្លៃ</span>
								<span style="padding-right: 10px !important;"><b><?php if($product->order_discount){ echo $this->erp->formatMoney($product->order_discount); }else{
									echo "……………………………";
								} ?></b></span>
						...
						<div>
							<table style="width:95%;font-family: Khmer OS Battambang;font-size: 12px;color: #2b4666;">
								<tr>
									<td>ឈ្មោះ</td>
