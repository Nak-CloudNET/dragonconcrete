...
<div class="row">
    ...
    <div class="col-sm-2">
	 ...
	 <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
                                echo form_open('sale_order/down_payment/'.$inv->id ,$attrib);
								...
								<div class="col-md-4">
									...
									<div class="form-group">
										...
										<input name="down_payment" type="text" id="down_payment"
											   class="form-control down_payment" value="0"
							...
							<div class="col-md-0">
							   <div class="col-md-4">
									...
									<div class="form-group">
										...
										<input name="priciple_loan" type="text" id="priciple_loan" value=""  class="form-control priciple_loan" placeholder="<?= lang('priciple_loan') ?>"/>
									</div>
								</div>
							</div>
							<div class="col-md-0">
							   <div class="col-md-4">
									...
									<div class="form-group">
										...
										<input name="priciple_term" type="text" id="priciple_term" value="" class="form-control priciple_term" placeholder="<?= lang('priciple_term') ?>"/>
									</div>
								</div>
							</div>
							<div class="col-md-0">
							   <div class="col-md-4">
									...
									<div class="form-group">
										...
										<input name="loan_amount" type="text" id="loan_amount" value="<?= $this->erp->formatDecimal($inv->grand_total - ($inv->paid)); ?>" style="pointer-events:none" class="form-control loan_amount" placeholder="<?= lang('loan_amount') ?>"/>
									</div>
								</div>
							</div>
						</div>
									...
									<div class="col-md-12">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<?php
													...
													{
														$opt.="<option value=".$term->day .">".$term->description ."</option>";
													}
													echo $opt;
													?>
										...
										<div class="col-md-4">
											...
											<label for="down_date"><?= lang('down_date') ?></label>
												 <?php echo form_input('down_date', date("d/m/Y"), 'class="form-control date" id="down_date" required="required"'); ?>
											</div>
										</div>
							...
							<div class="col-lg-12">
								<div class="col-md-6">
									<div class="form-group">
										...
										<?php echo form_input('jl_gov_id', (isset($_POST['jl_gov_id']) ? $_POST['jl_gov_id'] : ''), 'class="form-control number_only" id="jl_gov_id" '); ?>
									</div>
									<div class="form-group">
										<?= lang("name", "jl_name"); ?>
										<?php echo form_input('jl_name', (isset($_POST['jl_name']) ? $_POST['jl_name'] : ''), 'class="form-control" id="jl_name" '); ?>
									</div>
									
									<div class="form-group">
										<?= lang("date_of_birth", "jl_dob"); ?>
										<?php echo form_input('jl_dob', (isset($_POST['jl_dob']) ? $_POST['jl_dob'] : ''), 'class="form-control date" id="jl_dob" '); ?>
									</div>													
								...
								<div class="col-md-6">															
									...
									<div class="form-group">
										...
										<input type="tel" name="jl_phone_1" class="form-control number_only" maxlength="10" id="jl_phone_1" value="<?php (isset($_POST['jl_phone_1']) ? $_POST['jl_phone_1'] : '') ?>"/>
									</div>
...
$( document ).ready(function() {	
	var site = <?= json_encode(array('base_url' => base_url(), 'settings' => $Settings, 'dateFormats' => $dateFormats)) ?> 
		...
		$('#depreciation_type_1, #depreciation_rate_1, #depreciation_term_1, #loan_amount, #frequency, #down_date, #down_payment').on("change",function() {
			...
			var loan_amount   = total_amount - (deposit+down_pay+priciple_loan);
					...
					if(p_type == 1){
						...
						for(i=1;i<=term;i++){
							if(i== 1){
								...
								var dateline = moment(start_date).add(a,'days').format('DD/MM/YYYY');
							}else{
