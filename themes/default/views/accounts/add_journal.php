				...
				<?php }else{ ?>
					<div class="col-md-4">
						<div class="form-group">
							...
							echo form_dropdown('biller_id', $bl, (isset($_POST['biller_id']) ? $_POST['biller_id'] : $this->session->userdata("biller_id")), 'class="form-control" id="biller" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("biller") . '" required="required" style="pointer-events: none;"');
							?>
						</div>
					</div>
				<?php } ?>
