...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            "aoColumns": [{"bSortable": false,"mRender":checkbox}, {"mRender": fld}, {"mRender": fld}, {"mRender": ref}, {"mRender": ref}, null, null, {"mRender": paid_by}, {"mRender": currencyFormat}, {"mRender": row_status}],
			...
			{column_number: 6, filter_default_label: "[<?=lang('noted');?>]", filter_type: "text", data: []},
