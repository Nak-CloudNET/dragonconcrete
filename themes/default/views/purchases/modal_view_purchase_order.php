                ...
                <table class="table table-bordered table-hover table-striped print-table order-table">
                    ...
                    ?>
    					...
    					<?php if ($inv->shipping != 0) {
                            echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . lang("shipping") . '</td><td style="text-align:right; padding-right:10px;">' . abs($this->erp->formatMoney($inv->shipping)) . '</td></tr>';
                        }
                        ?>
            ...
            <?php if (!$Supplier || !$Customer) { ?>
                <div class="buttons">
                    ...
                    <div class="btn-group btn-group-justified">
                        ...
                        <?php } ?>
                        <div class="btn-group">
                            <a href="<?= site_url('purchases/tcs_invoice/' . $inv->id) ?>" 
                           target="_blank" class="tip btn btn-primary" title="<?= lang('email') ?>">
                                <i class="fa fa-file-text-o"></i>
                                <span class="hidden-sm hidden-xs"><?= lang('tcs_invoice') ?></span>
                            </a>
                        </div>
