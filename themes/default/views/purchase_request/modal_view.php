            ...
            <?php if (!$Supplier || !$Customer) { ?>
                <div class="buttons">
                    ...
                    <div class="btn-group btn-group-justified">
						...
						<div class="btn-group">
                            <a href="<?= site_url('purchases_request/invoice_phum_meas/' . $inv->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('invoice_phum_meas') ?>">
                                <i class="fa fa-download"></i>
                                <span class="hidden-sm hidden-xs"><?= lang('Phum Meas') ?></span>
                            </a>
                        </div>
