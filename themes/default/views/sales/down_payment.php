...
<?php foreach($order_loans as $order_loan) {
	    $total_sched = $this->erp->formatMoney($order_loan->interest)+$this->erp->formatMoney($order_loan->principle);
	    $grandtotal += $total_sched; 
	    $total_prin = $order_loan->principle;
	    $grandtotal_prin += $total_prin;
	    $rate = $order_loan->rated;
	    $total_balance += $order_loan->balance;
	    $monthly_paid = $order_loan->payment;
	} ?>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                <div style="max-width:200px; margin: 0 auto;">
                    ...
                    <?php 
					//$this->erp->print_arrays($inv->attachment);
                                    ...
                                    <div class="col-md-12">
										<table width="100%" style="line-height:31px">
											...
											<tr>
												...
												<input type="hidden" name="biller_logo" class="biller_logo" id="biller_logo" value="<?=$biller->logo?>">
										</table>
								...
								<div class="col-md-4">
									...
									<div class="form-group">
										...
										<input name="down_payment" type="text" id="down_payment"
											   class="form-control down_payment" value="<?=$this->erp->formatDecimal($order_down->down_amount);?>"
						    ...
						    <div class="col-md-4">
								<div class="form-group">
									<label for="down_date"><?= lang('down_date') ?></label>
										 <?php echo form_input('payment_down_date', date("d/m/Y"), 'class="form-control date" id="payment_down_date" required="required"'); ?>
								</div>
							</div>
							<div class="col-sm-4" id="payment_ref">
								<div class="form-group">
							...
							<div class="col-md-0">
							   <div class="col-md-4">
									...
									<div class="form-group">
										...
										<input name="priciple_loan" type="text" id="priciple_loan" value="<?=$this->erp->formatDecimal($order_down->principle_amount);?>"  class="form-control priciple_loan" placeholder="<?= lang('priciple_loan') ?>"/>
									</div>
								</div>
							</div>
							<div class="col-md-0">
							...
							<div class="col-md-0">
							   <div class="col-md-4">
									...
									<div class="form-group">
										...
										<input name="loan_amount" type="text" id="loan_amount" value="<?= $this->erp->formatDecimal($inv->grand_total - ($inv->paid+$order_down->principle_amount+$order_down->down_amount)); ?>" style="pointer-events:none" class="form-control loan_amount" placeholder="<?= lang('loan_amount') ?>"/>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
											<div class="form-group">
												...
												<input name="depreciation_rate1" type="text" id="depreciation_rate_1"
													   class="form-control number_only depreciation_rate1" value="<?=$order_down->interest_rate?>"
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<?php
													...
													{
														$opt.="<option ".($order_down->term==$term->day?"selected":"")." value=".$term->day .">".$term->description ."</option>";
													}
													echo $opt;
													?>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<select name="frequency" id="frequency"
													...
													{
														$opt.="<option ".($order_down->frequency==$fre->day?"selected":"")." value=".$fre->day .">".$fre->description ."</option>";
													}
													echo $opt;
													?>
												</select>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<select name="depreciation_type" id="depreciation_type_1"
													...
													<option value=""> &nbsp; </option>
													<option <?=($order_down->depreciation_type==1?"selected":"");?> value="1"><?= lang("normal"); ?></option>
													<option <?=($order_down->depreciation_type==2?"selected":"");?> value="2"><?= lang("custom"); ?></option>
													<option <?=($order_down->depreciation_type==3?"selected":"");?> value="3"><?= lang("fixed"); ?></option>
													<option <?=($order_down->depreciation_type==4?"selected":"");?> value="4"><?= lang("normal_fixed"); ?></option>
												</select>
											</div>
										</div>
										<div class="col-md-4">
										...
										<div class="col-md-4">
											<div class="form-group">
											<label for="down_date"><?= lang('down_date') ?></label>
												 <?php echo form_input('down_date', date("d/m/Y",strtotime($order_down->installment_date)), 'class="form-control date" id="down_date" required="required"'); ?>
											</div>
										</div>
							...
							<div class="col-lg-12">
								<div class="col-md-6">
									...
									<input type="hidden" name="jl_id" value="<?=$jl_data->id?>">
										...
										<?php echo form_input('jl_gov_id', (isset($_POST['jl_gov_id']) ? $_POST['jl_gov_id'] : $jl_data->identify_card), 'class="form-control number_only" id="jl_gov_id"'); ?>
									</div>
									<div class="form-group">
										<?= lang("name", "jl_name"); ?>
										<?php echo form_input('jl_name', (isset($_POST['jl_name']) ? $_POST['jl_name'] :  $jl_data->name), 'class="form-control" id="jl_name" '); ?>
									</div>
									
									<div class="form-group">
										<?= lang("date_of_birth", "jl_dob"); ?>
										<?php echo form_input('jl_dob', (isset($_POST['jl_dob']) ? $_POST['jl_dob'] :date("d/m/Y",strtotime( $jl_data->date_of_birth))), 'class="form-control date" id="jl_dob" '); ?>
									</div>													
								...
								<div class="col-md-6">															
									...
									<div class="form-group">
										...
										<?php
										$jl_gender[(isset($_POST['jl_gender']) ? $_POST['jl_gender'] : $jl_data->gender)] = (isset($_POST['jl_gender']) ? $_POST['jl_gender'] : '');
										$jl_gender['ប្រុស'] = "ប្រុស";
										$jl_gender['ស្រី'] = "ស្រី";
										echo form_dropdown('jl_gender', $jl_gender, isset($_POST['jl_gender'])?$_POST['jl_gender']:'', 'class="form-control select" id="jl_gender" placeholder="' . lang("select") . ' ' . lang("gender") . '" style="width:100%" ')
										?>
									</div>
									
									<div class="form-group">
										<?= lang("phone", "jl_phone_1"); ?>
											<?php echo form_input('jl_phone_1', (isset($_POST['jl_phone_1']) ? $_POST['jl_phone_1'] :$jl_data->phone), 'class="form-control" id="jl_phone_1" style="pointer-events:none;"');?>
									</div>
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<?php echo form_textarea('jl_address', (isset($_POST['jl_address']) ? $_POST['jl_address'] : $jl_data->address), 'class="form-control" id="jl_address" style="margin-top: 10px; height: 130px;"'); ?>
									</div>
								</div>
							</div>
						</div>
...
$( document ).ready(function() {	
	var site = <?= json_encode(array('base_url' => base_url(), 'settings' => $Settings, 'dateFormats' => $dateFormats)) ?> 
		...
		$("#depreciation_type_1,#jl_dob").trigger("change");
		...
		$('#principle_type_1, #loan_amount,#down_date').on('change',function()
		{
			var option = $("#principle_type_1 option:selected").val();
			if(option!='none')
			{
	...
	function PopupPayments() {
		...
		var type = $('#depreciation_type_1').val();
		var biller_logo = $('#biller_logo').val();
		var issued_date = $('.current_date').val();
				...
				mywindow.document.write('<div class="col-lg-12 col-xs-12"><br>');
					...
					mywindow.document.write('<table class="table table-bordered" style="width: 95%;margin: 0 auto;">');
						mywindow.document.write('<tr>');
							...
							mywindow.document.write('<img src="<?= base_url() ?>assets/uploads/logos/'+ biller_logo +'">');
							...
							mywindow.document.write('<td colspan="2"><p><b>: US$ <?php echo $this->erp->formatMoney($rows->unit_price); ?></b></p></td>');
						mywindow.document.write('</tr>');
						mywindow.document.write('<tr>');
							mywindow.document.write('<td><p style="font-family: Moul, cursive;margin-top:8px;">ទឹកប្រាក់កក់</p></td>');
							mywindow.document.write('<td><p style="margin-top:8px;"><?php echo $this->erp->formatMoney($deposit->amount*100/$rows->unit_price); ?>%</p></td>');
							mywindow.document.write('<td><p style="margin-top:8px;">$<?php echo $this->erp->formatMoney($deposit->amount); ?></p></td>');
						mywindow.document.write('</tr>');
						mywindow.document.write('<tr>');
							...
							mywindow.document.write('<td style="width: 25%;" colspan="2">');
								...
								mywindow.document.write('</b><?= $customer->name ? $customer->name : $customer->company; ?></p>');
							mywindow.document.write('</td>');
							...
							mywindow.document.write('<td style="width: 8%;">');
								mywindow.document.write('<p style="margin-top:8px;">: <?php echo $frequen->description; ?></p>');
							mywindow.document.write('</td>');
							mywindow.document.write('<td style="width: 12%;">');
							mywindow.document.write('<p style="margin-top:8px;"><span><?= $frequen->principle_type == 0 ? $grandtotal : $grandtotal_prin ?></span></p>');
							mywindow.document.write('</td>');
						mywindow.document.write('</tr>');
						mywindow.document.write('<tr>');
							mywindow.document.write('<td><p style="font-family: Moul, cursive;margin-top:8px;">ទូរស័ព្ទ</p></td>');
							mywindow.document.write('<td colspan="2"><p style="margin-top: 8px;"><?= $customer->phone; ?></p></td>');
							mywindow.document.write('<td style="border-bottom-color:white !important;"></td>');
							mywindow.document.write('<td><p style="font-family: Moul, cursive;margin-top:8px;">ទឹកប្រាក់បង់រម្លស់</p></td>');
							mywindow.document.write('<td colspan="2"><p style="margin-top:8px;"><span>$</span >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><?php echo $this->erp->formatMoney($total_balance); ?></span></p></td>');
						mywindow.document.write('</tr>');
						mywindow.document.write('<tr>');
							mywindow.document.write('<td><p style="font-family: Moul, cursive;margin-top:8px;">លេខផ្ទះ. ផ្លូវ</p></td>'+
								                    '<td><p style="margin-top:8px;"><b></b></p></td>'+
								                    '<td><p style="margin-top:8px;"><b></b></p></td>'+
						...
						mywindow.document.write('</tr>');
						mywindow.document.write('<tr>');
							mywindow.document.write('<td><p style="font-family: Moul, cursive;margin-top:8px;">អត្តសញ្ញាណប័ណ្ណ</p></td>'+
								                    '<td colspan="2"><p style="margin-top:8px;"></p></td>'+
								                    '<td style="border-bottom-color:white !important;"></td>'+
								                    '<td><p style="font-family: Moul, cursive;margin-top:8px;">រយះពេល</p></td>'+
								                    '<td><p style="margin-top:8px;">: <?php echo $frequen->description; ?></p></td>'+
								                    '<td>');
							mywindow.document.write('<p style="margin-top:8px;"><span><?= $frequen->principle_type == 0 ? $grandtotal : $grandtotal_prin ?></span></p>');
							mywindow.document.write('</td>');
						mywindow.document.write('</tr>');
						mywindow.document.write('<tr>');
							mywindow.document.write('<td><p style="font-family: Moul, cursive;margin-top:8px;">កាលបរិច្ឆេទ</p></td>'+
								                    '<td colspan="2"><p style="margin-top:8px;">: <?= $this->erp->hrld($inv->date); ?></p></td>'+
								                    '<td style="border-bottom-color:white !important;"></td>'+
					...
					mywindow.document.write('<div class="col-lg-12 col-xs-12"><br>');
						mywindow.document.write('<table class="table table-bordered" style="width: 95%;margin: 0 auto;">');
							mywindow.document.write('<thead  style="font-size: 12px;font-family: Moul, cursive;">');
								mywindow.document.write('<tr>');
									mywindow.document.write('<td style="width: 5%;text-align: center;">'+
									                            '<p><u>លេខ</u></p>'+
									                            '<p><u>រៀង</u></p>'+
									                        '</td>');
									mywindow.document.write('<td style="width: 15%;text-align: center;">'+
									                            '<p><u>កាលបរិច្ឆេទ</u></p>'+
									                            '<p><u>បង់ប្រាក់</u></p>'+
									                        '</td>');
														if (type == 2) {
									mywindow.document.write('<td style="width: 15%;text-align: center;">'+
									                            ...
									                            '<p><u>ប្រចាំខែ</u></p>'+
									                        '</td>');
									mywindow.document.write('<td style="width: 8%;text-align: center;">'+
									                            '<p></p>'+
									                            '<p><u>ការប្រាក់</u></p>'+
									                        '</td>');
									mywindow.document.write('<td style="width: 10%;text-align: center;">'+
									                            '<p></p>'+
									                            '<p><u>ប្រាក់ដើម</u></p>'+
									                        '</td>');
														} else {
									...
									mywindow.document.write('<td style="width: 10%;text-align: center;">'+
								 	...
								 	mywindow.document.write('<td style="width: 18%;text-align: center;">'+
									                            '<p></p>'+
									                            '<p><u>សមតុល្យ</u></p>'+
									                        '</td>');
									mywindow.document.write('<td style="width: 10%;text-align: center;">'+
							...
							mywindow.document.write('<tbody>');
								...
								mywindow.document.write('<tr>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p>'+ k +'</p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p>'+ tr.find('.dateline').val() +'</p></td>');
														if(type == 2){
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p>'+ formatMoney(tr.find('.total_payment').val()-0) +'</p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p>'+ formatMoney(tr.find('.rate').val()-0) +'</p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p>'+ formatMoney(tr.find('.percentage').val()-0) +'</p></td>');
														} else {
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p>'+ formatMoney(tr.find('.payment_amt').val()-0) +'</p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p>'+ formatMoney(tr.find('.interest').val()-0) +'</p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p>'+ formatMoney(tr.find('.principle').val()-0) +'</p></td>');
														}
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p>'+ balance +'</p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
								mywindow.document.write('</tr>');
													});
								...
								mywindow.document.write('<tr>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p><b>'+ formatMoney(amount_total_pay) +'</b></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p><b>'+ formatMoney(total_princ) +'</b></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
								...
								mywindow.document.write('<tr>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p><b>'+ formatMoney(total_pay_) +'</b></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p><b>'+ formatMoney(total_princ) +'</b></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
									mywindow.document.write('<td style="width: 5%;text-align: center;"><p></p></td>');
					...
					mywindow.document.write('</div>');
					mywindow.document.write('<div class="col-lg-12 col-xs-12">'+
