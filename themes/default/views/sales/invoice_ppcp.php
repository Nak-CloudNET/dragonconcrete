	...
	<div class="container" style="width: 830px;margin: 0 auto;">
		<div class="col-xs-12" style="width:810px !important;">
			...
			<div class="col-sm-3 col-xs-3">
				<?php if(!empty($biller->logo)) { ?>
					<img src="<?= base_url() ?>assets/uploads/logos/<?= $biller->logo; ?>" style="width: 165px; margin-left: 25px; margin-top:-20px !important;" />
				<?php } ?>
			</div>
			
			<div class="col-sm-6 col-xs-6 company_addr" style="margin-top: 17px !important">
				<center>
			...
			<div class="row">
				<div class="col-sm-7 col-xs-7">
					<table style="font-size:12px;margin-top:-20px;">
						...
						<tr>
							<td style="width: 5%; font-size:13px !important;">ឈ្មោះក្រុមហ៊ុន </br> Company Name</td>
							<td style="width: 5%;">:</td>
						...
						<tr>
							<td style="font-size:12px !important;">អតិថិជន </br> Customer Name</td>
							<td>:</td>
						...
						<tr>
							<td style="font-size:13px !important;">អាសយដ្ឋាន </br> Address</td>
							<td>:</td>
						...
						<tr>
							<td style="font-size:12px !important;">លេខអត្តសញ្ញាណកម្ម អតប </br> VAT No.</td>
							<td>:</td>
				...
				<div class="col-sm-5 col-xs-5">
					<table style="font-size: 12px;margin-top:-20px;">
						<tr>
							<td style="width: 20%;font-size:12px !important;">លេខរៀងបញ្ជារទិញ </br> So No.</td>
							<td style="width: 5%;">:</td>
							<td style="width: 30%;font-size:12px !important;"><?= $sale_order->reference_no ?></td>
						</tr>
						<tr>
							<td style="width: 20%;font-size:12px !important;">លេខរៀងវិក្កយបត្រ </br> Invoice No.</td>
							<td style="width: 5%;">:</td>
							<td style="width: 30%;font-size:12px !important;"><?= $invs->reference_no ?></td>
						</tr>
						<tr>
							<td style="font-size:12px !important;">កាលបរិច្ឆេទ </br> Date</td>
							<td>:</td>
							<td style="font-size:12px !important;"><?= $invs->date; ?></td>
						</tr>
						<tr>
							<td style="font-size:12px !important;">អ្នកលក់</br> Saleman</td>
							<td>:</td>
							<td style="font-size:13px !important;"><?= $saleman->username; ?></td>
						</tr><tr>
							<td style="font-size:12px !important;">រយះពេលបង់ប្រាក់</br>​Payment Term</td>
							<td>:</td>
		...
		<div id="footer" class="row">
			...
			<div class="col-lg-3 col-sm-3 col-xs-3">
				<hr style="margin:0; border:1px solid #000;">
				<center>
					<p style="font-size: 12px !important;">ហត្ថលេខា និងឈ្មោះគណនេយ្យ</p>
					<p style="margin-top:-10px;font-size:11px !important;">Account's Signature & Name</p>
				</center>
			</div>
			<div class="col-lg-3 col-sm-3 col-xs-3">
				<hr style="margin:0; border:1px solid #000;">
				<center>
					...
					<p style="margin-top:-10px !important;font-size:11px !important;">Warehouse's Signature & Name</p>
				</center>
			</div>
			<div class="col-lg-3 col-sm-3 col-xs-3">
				<hr style="margin:0; border:1px solid #000;">
				<center>
					...
					<p style="margin-top:-10px !important;font-size:11px !important;">Delivery's Signature & Name</p>
				</center>
			</div>
		</div>
	</div>
