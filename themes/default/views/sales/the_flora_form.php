		...
		<div class="col-lg-12">
			...
			<div class='row col-lg-12 font-kh-bt'>
				<p>
					...
					ដែលបានធ្វើឡើងនៅភ្នំពេញថ្ងៃទី <b><?=$date_day;?></b>
					ខែ <b><?=$month_kh;?></b> 
					ឆ្នាំ​ <b><?=$date_year?></b> 
					កិច្ចសន្យានេះធ្វើឡើងនៅថ្ងៃទី <b><?=$date_day;?></b>
					ខែ <b><?=$month_kh;?></b> 
					ឆ្នាំ​<b> <?=$date_year?></b> រវាង:
			    ​​​​​​</p>
				<!--Saller-->
				<p>
					...
					ខ័ណ្ឌ<?=$saller->district;}?> 
					<?php if($saller->country){?><?=$saller->country;}?> 
				...
				<p>
				 ...
				 ​​​​	 ភេទ <b><?=$customer->gender;?></b> 
					...
					<b><?=($jl_data->identify_card!=""?$jl_data->identify_card:"...........")?></b>
			...
			<div class='row col-lg-12 font-kh-bt'>
				...
				<p>
					...
					<?=$this->erp->formatMoney($product->subtotal);?>( <?=$this->erp->numberToWordsCur($product->subtotal,"kh","");?> ដុល្លារអាមេរិក) សម្រាប់រយះពេល <?=round($duration->duration);?> <b>(<?=$duration->description;?>)</b>ឆ្នាំក្នុងអត្រាការប្រាក់<b>12%</b>	(ដប់ពីរភាគរយ)ក្នុង១ឆ្នាំ។ភាគី“ខ”ត្រូវសងតាមឥណប្រតិទានប្រចាំខែចំនួន <b><?php echo $payment?></b>លើកចំនួនទឹកប្រាក់<b><?php echo $total_payment?></b>ដុល្លារអាមេរិកដោយបង់រម្លស់ប្រាក់ដើមបូក
				...
				<div class="row col-lg-12 font-kh-bt">
					<p>
						...
						រាជធានីភ្នំពេញ ថ្ងៃទី<b><?=$db_down_pay_date;?> </b>
						ខែ  <b><?=$db_down_pay_month;?> </b> 
						ឆ្នាំ​  <b><?=$db_down_pay_year?> </b>
						</span>
					</p>
				</div>
