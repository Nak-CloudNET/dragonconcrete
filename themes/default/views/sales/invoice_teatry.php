						...
						<body class="body_append">
							...
							?>
								<tr class="blank" style="font-size: 13px;border-bottom: 1px solid #ddd;">
									...
									<?php
										if ($Settings->product_discount){
												echo '<td class="border" style="width: 100px; text-align:center; vertical-align:middle;">' . ($row->discount != 0 ? '<small>(' . $row->discount . ')</small> ' : '') . $this->erp->formatMoney($row->item_discount) . '</td>';
										}
									?>
									<td style="text-align:center;">
