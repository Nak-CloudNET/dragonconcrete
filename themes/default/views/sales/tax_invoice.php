			...
			<td colspan="5" width="65%" align="center" style="padding-top:5px;">
				<div class="row">
					<div class="col-sm-6 col-xs-6">
						...
						<div class="row">
							<div class="col-sm-7 col-xs-7" style="font-size:14px; text-align: left; font-weight: bold"><?= lang('លេខអត្តសញ្ញាណកម្ម អតប  (VATTIN)');?></div>
							<div class="col-sm-5 col-xs-5 text-left">
								<?= $customer->vat_no; ?>
							</div>
						</div>
					...
					<div class="col-sm-6 col-xs-6">
						<div class="row">
							<div class="col-sm-7 col-xs-7 text-left" style="padding-left: 100px">
				...
				<!-- <table width="100%">
					...
					<tr>
						<td width="25%" style="font-size:14px;"> <?= lang('ទូរស័ព្ទ​លេខ <br> Telephone No');?> </td>
					...
					<tr>
						<td width="25%" style="font-family:'Khmer OS'; font-size:14px; font-weight: bold"> <?= lang('លេខអត្តសញ្ញាណកម្ម អតប  (VATTIN)');?></td>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-hover table-striped print-table order-table" style="margin-top: 10px">
						...
						<tr>
							...
							// }
							?>
							<th style="text-align:center;"><?=lang("បញ្ចុះតម្លៃឯកតា​ <br/> Discount")?></th>
						...
						?>
							<tr>
								...
								//}
								?>
								<td style="width: 100px; text-align:right; vertical-align:middle;"><?=($row->discount != 0 ? '<small>(' . $row->discount . ')</small> ' : '') . $this->erp->formatMoney($row->item_discount)?></td>
						...
						<tr>
							...
							<td style="text-align:right; padding-right:10px;"><?= lang("សរុប <br/> Total"); ?></td>
							<?php
							if ($Settings->tax1) {
						...
						<?php if ($Settings->tax2 && $inv->order_tax != 0) {
							echo '<tr><td colspan="' . $tcol . '" style="text-align:right; vertical-align:middle !important; padding-right:10px;;">' . lang("ពន្ធអាករ <br/> Order Tax") . ' (' . $default_currency->code . ')</td><td style="text-align:right; vertical-align:middle; padding-right:10px;">' . $this->erp->formatMoney($inv->shipping) . '</td></tr>';
						}
						?>
						...
						<tr>
							...
							<td style="text-align:right; font-weight:bold; padding-top:20px;"><?= $this->erp->formatMoney($inv->grand_total - (($inv->paid-$inv->deposit) + $inv->deposit)); ?></td>
						</tr>
						<?php }?>
						</tfoot>
					</table>
