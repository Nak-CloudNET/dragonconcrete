        ...
        <div class="modal-body">
            ...
            <?php if ($Owner || $Admin) { ?>
                <div class="form-group">
                    <?= lang("date", "date"); ?>
                    <?= form_input('date', (isset($_POST['date']) ? $_POST['date'] : $this->erp->hrld($delivery->date)), 'class="form-control datetime" id="date" required="required"'); ?>
                </div>
            <?php } ?>
            <div class="form-group">
			...
			<div class="form-group">
				...
				echo form_dropdown('sale_delivery_status', $post, (isset($_POST['sale_delivery_status']) ? $_POST['sale_delivery_status'] : $delivery->delivery_status), 'id="postatus" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("status") . '" required="required" style="width:100%;" ');
				?>
			</div>
