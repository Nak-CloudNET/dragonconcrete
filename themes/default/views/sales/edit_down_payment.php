...
<div class="row">
    ...
    <div class="col-sm-10">
		 ...
		 <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
                                echo form_open('sales/edit_down_payment/'.$inv->id ,$attrib);
							   ...
							   <div class="col-md-4">
									...
									<div class="form-group">
										...
										<input name="loan_amount" type="text" id="loan_amount" style="pointer-events:none"
											   class="form-control loan_amount" value="<?=$this->erp->formatDecimal($inv->grand_total - ($inv->deposit+$order_down->down_amount+$order_down->principle_amount)) ?>"
									...
									<div class="col-md-12">
										<div class="col-md-4">
											<div class="form-group">
												...
												<input name="depreciation_rate1" type="text" id="depreciation_rate_1" value="<?=$LoanRated->rated?>"
...
$( document ).ready(function() {	
	...
	var site = <?= json_encode(array('base_url' => base_url(), 'settings' => $Settings, 'dateFormats' => $dateFormats)) ?> 
		...
		$('#depreciation_type_1, #depreciation_rate_1, #depreciation_term_1, #loan_amount, #frequency, #down_date, #down_payment').on("change",function() {
			...
			var loan_amount   = total_amount - (down_pay+prin_loan);
				...
				mywindow.document.write('<div class="col-lg-12 col-xs-12"><br>');
					...
					mywindow.document.write('<table class="table table-bordered" style="width: 95%;margin: 0 auto;">');
						...
						mywindow.document.write('<tr>');
							...
							mywindow.document.write('<td><p style="margin-top:8px;"><?php echo $this->erp->formatMoney($payments->amount*100/$rows->unit_price); ?>%</p></td>');
							mywindow.document.write('<td><p style="margin-top:8px;">$<?php echo $this->erp->formatMoney($payments->amount); ?></p></td>');
						mywindow.document.write('</tr>');
						mywindow.document.write('<tr>');
