            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all" id="unit_fg">
                       ...
                       <div class="input-group" id="unit_input"> <?php
                        $ut[""] = "";
						foreach($unit as $uts){
							$ut[$uts->id] = $uts->name;
						}
                ...
                <div class="col-md-6 col-md-offset-1">
                                ...
                                <table id="attrTable" class="table table-bordered table-condensed table-striped" style="<?= $this->input->post('attributes') || $product_options ? '' : 'display:none;'; ?>margin-bottom: 0; margin-top: 10px;">
									...
									?>
                                            <tr class="attr">
												...
												<td class="price text-right"><input type="hidden" name="attr_price[]" value="<?= $this->erp->formatQuantity($option->price);?>"><span><?= $this->erp->formatQuantity($option->price);?></span></td>
					...
					<div class="service" style="display:none;">
						<fieldset class="scheduler-border">
							<legend class="scheduler-border"><?= lang('service_type');?>:</legend>
							<?= lang('home');?>: <input type="radio" name="service_type" value="1">
							<?= lang('cost');?>: <input type="radio" name="service_type" value="2">
						</fieldset>
					</div>
                    ...
                    <div class="row" id="extras-con" style="display: none;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                ...
                                <?php
									$ht[''] = "";
									foreach ($home_type as $htype) {
										$ht[$htype->id] = $htype->plan;
									}
									echo form_dropdown('cf1', $ht, '', 'class="form-control" id="cf1" placeholder="' . lang("select") . " " . lang("home_type") . '" style="width:100%"')
								?>
                            </div>
                        </div>
